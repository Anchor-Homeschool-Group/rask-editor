...
function matchAttributor(node, delta, scroll) {
  ...
  return Object.entries(formats).reduce((newDelta, [name, value]) => applyFormat(newDelta, name, value, scroll), delta);
}
...
function matchStyles(node, delta, scroll) {
  ...
  delta = Object.entries(formats).reduce((newDelta, [name, value]) => applyFormat(newDelta, name, value, scroll), delta);
  // @ts-expect-error
